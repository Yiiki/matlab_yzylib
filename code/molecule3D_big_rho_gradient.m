function axout = molecule3D_big_rho_gradient(varargin)
...
for k = ks % draw sticks for all bounds
    ...
    alpha=func_alpha2(max(r1(2),r2(2)));
...
% ----------------------------------------
% alpha function
function alp=func_alpha(y)
alp=exp(-(y/12).^4);
function alp=func_alpha2(y)
alp=exp(-(y/12).^4);
